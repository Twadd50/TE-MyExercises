...
-- 1. The name and population of all cities in Ontario, Canada (27 rows)  (((27 rows is what youre expecting to get back)))
FROM world SELECT name, population FROM city WHERE district = 'Ontario'
...
SELECT (gnp / population) * 1000000 FROM country WHERE continent = 'Europe'
